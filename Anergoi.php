...
<body>
    ...
    <ol class="breadcrumb" style="margin-top: 0px;margin-bottom: -1px;background-color: #172c10;">
        <?php require 'breadcrumbs.php'?>
    </ol>
    <div style="height: 1000px;">
        <div class="container-fluid" style="height: 1000px;">
            <div class="row" style="height: 1000px;">
                <div class="col-md-6" style="background-image: url(&quot;assets/img/cashmeoutside.jpg&quot;);background-repeat: no-repeat;background-size: cover;background-position: right;">
                    <div class="float-right" style="margin-top: 160px;margin-bottom: -2px;height: 13px;background-color: #172c10;width: 90%;margin-right: 8%;"></div>
                    <div class="card shadow-lg float-right" style="height: 600px;margin-top: 0px;background-color: rgba(255,255,255,0.9);width: 90%;margin-right: 8%;">
                        <div class="card-header" style="color: #f0f9ff;">
                            <h1 style="display:none;">h1</h1><h2 class="text-center mb-0" style="color: #282d32;">Επίδομα Ανεργίας</h2>
                        </div>
                        <div class="card-body">
                            <p class="card-text" style="color: #282d32;font-size: 22px;margin-bottom: 143px;">Η Τακτική Επιδότηση Ανεργίας είναι μια παροχή που χορηγείται σε μισθωτούς, ασφαλισμένους στον<strong> κλάδο ανεργίας του ΟΑΕΔ</strong> των οποίων η εργασιακή σχέση είτε έληξε (σύμβαση ορισμένου χρόνου) είτε καταγγέλθηκε από
                                τον εργοδότη, με χρονική διάρκεια από πέντε έως 12 μήνες ανάλογα με τις ημέρες εργασίας που έχουν πραγματοποιήσει οι δικαιούχοι σε συγκεκριμένα χρονικά διαστήματα <strong>πριν από τη λύση ή τη λήξη</strong> της εργασιακής
                                τους σχέσης, που <strong>ορίζονται ως κρίσιμα</strong>.<br></p>
                            <p class="text-center card-text" style="color: #282d32;font-size: 22px;"><strong>Για περισσότερες πληροφορίες, προϋποθέσεις, διαδικασία υποβολής και άλλα στον παρακάτω σύνσεσμο.</strong></p><a class="btn btn-primary btn-block border rounded border-white shadow" role="button" data-bs-hover-animate="pulse" style="background-color: #172c10;font-size: 22px;" href="http://www.oaed.gr/paroches-anergias"><strong>Περισσότερα</strong></a></div>
                    </div>
                </div>
                <div class="col-md-6" style="background-image: url(&quot;assets/img/aergosmpastardos.jpg&quot;);background-repeat: no-repeat;background-size: cover;background-position: right;">
                    <div style="margin-top: 160px;margin-bottom: -2px;height: 13px;background-color: #172c10;width: 90%;margin-left: 8%;"></div>
                    <div class="card shadow-lg" style="height: 600px;margin-top: 0px;background-color: rgba(255,255,255,0.9);width: 90%;margin-left: 8%;">
                        <div class="card-header" style="color: #f0f9ff;">
                            <h1 style="display:none;">h1</h1><h2 class="text-center mb-0" style="color: #282d32;">Έκδοση Δελτίου Ανεργίας</h2>
                        </div>
                        <div class="card-body">
                            <p class="card-text" style="color: #282d32;font-size: 22px;margin-bottom: 74px;">Ένα μεγάλο θέμα είναι αυτό του <strong>ΟΑΕΔ</strong>&nbsp;και την έκδοση της κάρτας ανεργίας, δηλαδή:<br>Τι χαρτιά χρειάζομαι, που πρέπει να τα καταθέσω, πρέπει να κλείσω κάπου ραντεβού, η εγγραφή θα γίνει άμεσα, ποια είναι
                                τα δικαιώματα μου ως άνεργος, και κάθε πότε πρέπει να κάνω την ανανέωση; Όλα αυτά είναι ερωτήματα που θα απαντηθούν.<br>Πλέον, εύκολα, γρήγορα και απλά, χωρίς καθυστερήσεις και αναμονές, μπορείτε να γραφτείτε άνεργοι από
                                την εφαρμογή του ΟΑΕΔ, είτε με κωδικούς taxisnet είτε με κωδικούς του ΟΑΕΔ e services.<br></p>
                            <p class="text-center card-text" style="color: #282d32;font-size: 22px;"><strong>Για περισσότερες πληροφορίες, προϋποθέσεις, διαδικασία υποβολής και άλλα στον παρακάτω σύνσεσμο.</strong></p><a class="btn btn-primary btn-block border rounded border-white shadow" role="button" data-bs-hover-animate="pulse" style="background-color: #172c10;font-size: 22px;" href="https://www.gov.gr/ipiresies/ergasia-kai-asphalise/anergia/ekdose-deltiou-anergias"><strong>Περισσότερα</strong></a></div>
                    </div>
                </div>
            </div>
        </div>
