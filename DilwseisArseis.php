    ...
    <div style="height: 800px;">
        <div class="container-fluid" style="height: 1000px;">
            <div class="row" style="height: 800px;">
                <div class="col" style="background-image: url(&quot;assets/img/wowPollaNumeraPipiPupu.jpg&quot;);background-repeat: no-repeat;background-size: cover;background-position: center;">
                    <div style="height: 10px;margin-top: 230px;background-color: #171f32;margin-bottom: -1px;"></div>
                    <div class="card shadow-lg float-right" style="background-color: rgba(40,45,50,0.92);margin-top: 0px;height: 300px;width: 100%;">
                        <div class="card-header" style="color: #f0f9ff;">
                            <h1 style="display:none;">h1</h1><h2 class="text-center mb-0">Γενική Κατάσταση</h2>
                        </div>
                        <div class="card-body">
                            <p class="text-center card-text" style="color: #f0f9ff;font-size: 22px;margin-bottom: 136px;margin-top: 0px;">Μια γενική κατάσταση των δηλώσεων που έχετε υποβάλει για κάθε επιχείρησή σας.</p><a class="btn btn-primary btn-block border rounded border-white shadow float-right" role="button" data-bs-hover-animate="pulse" style="font-size: 20px;background-color: #171f32;margin-top: -55px;"
                                href="GenikhKatastashDhlwsewn.php"><strong>Περισσότερα</strong></a></div>
                    </div>
                </div>
                <div class="col" style="background-image: url(&quot;assets/img/polles%20xeirapsies.jpg&quot;);background-repeat: no-repeat;background-size: cover;background-position: center;">
                    <div style="background-color: #171f32;height: 10px;margin-top: 230px;margin-bottom: -1px;"></div>
                    <div class="card shadow-lg" style="background-color: rgba(40,45,50,0.92);height: 300px;">
                        <div class="card-header" style="color: #f0f9ff;">
                            <h1 style="display:none;">h1</h1><h2 class="text-center mb-0">Εφαρμογή Δηλώσεων</h2>
                        </div>
                        <div class="card-body">
                            <p class="text-center card-text" style="color: #f0f9ff;font-size: 22px;margin-bottom: 48px;">Διεπαφή δήλωσης εργαζομένων σε οποιαδήποτε επιχείρησή σας σε κάποιο εναλλακτικό καθεστώς εργασίας.</p><a class="btn btn-primary btn-block border rounded border-white shadow float-right" role="button" data-bs-hover-animate="pulse"
                                style="font-size: 20px;background-color: #171f32;" href="DhlwseisErgodoth.php"><strong>Περισσότερα</strong></a></div>
                    </div>
                </div>
                <div class="col" style="background-image: url(&quot;assets/img/kanoumebusinesslmao.jpg&quot;);background-repeat: no-repeat;background-size: cover;background-position: center;">
                    <div style="background-color: #171f32;height: 10px;margin-top: 230px;margin-bottom: -1px;"></div>
                    <div class="card shadow-lg" style="background-color: rgba(40,45,50,0.92);">
                        <div class="card-header" style="color: #f0f9ff;">
                            <h1 style="display:none;">h1</h1><h2 class="text-center mb-0">Άρση Δηλώσεων</h2>
                        </div>
                        <div class="card-body">
                            <p class="text-center card-text" style="color: #f0f9ff;font-size: 22px;margin-bottom: 84px;">Διεπαφή άρσης δηλώσεων που είχαν εφαρμοστεί σε εργαζόμενους.</p><a class="btn btn-primary btn-block border rounded border-white shadow float-right" role="button" data-bs-hover-animate="pulse" style="font-size: 20px;background-color: #171f32;"
                                href="ArseisDhlwsewn.php"><strong>Περισσότερα</strong></a></div>
                    </div>
                </div>
            </div>
        </div>
