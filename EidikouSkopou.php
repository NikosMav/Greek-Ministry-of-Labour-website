...
<body>
    ...
    <header style="height: 700px;background-image: url(&quot;assets/img/family.jpg&quot;);background-repeat: no-repeat;background-size: cover;background-position: center;filter: blur(0px);">
        <div style="height: 700px;background-color: rgba(201,79,27,0.13);">
            <div class="card shadow-lg float-right" data-bs-hover-animate="pulse" style="width: 700px;margin-left: 0px;margin-right: 117px;margin-top: 122px;background-color: rgba(40,45,50,0.92);">
                <div class="border-light" style="height: 7px;background-color: #bd3b04;margin-top: -2px;width: 700px;margin-left: -1px;"></div>
                <div class="card-header" style="margin-top: 0px;background-color: rgba(0,0,0,0);">
                    <h1 style="display:none;">h1</h1><h2 style="display:none;">h2</h2><h3 style="display:none;">h3</h3><h4 style="display:none;">h4</h4><h5 class="mb-0" style="font-size: 22px;color: #f0f9ff;">Τι είναι η Άδεια Ειδικού Σκοπού;</h5>
                </div>
                <div class="card-body">
                    <p class="card-text" style="font-size: 18px;color: #f0f9ff;">Είναι η άδεια με πλήρεις αποδοχές που δικαιούται υπάλληλος, εφόσον είναι γονέας με παιδί στην πρωτοβάθμια ή δευτεροβάθμια εκπαίδευση (μέχρι και την Γ΄ Γυμνασίου) για την φυλαξη του, λόγω κλεισίματος των σχολείων.<br><br>Δικαιούχοι
                        είναι επίσης όσων τα παιδιά φοιτούν σε ειδικά σχολεία ή σχολικές μονάδες ειδικής αγωγής και εκπαίδευσης, <strong>ανεξαρτήτως ορίου ηλικίας</strong> των παιδιών ή είναι άτομα με αναπηρία και είναι ωφελούμενα σε δομές παροχής υπηρεσιών
                        ανοικτής φροντίδας,&nbsp;<strong>ανεξαρτήτως της ηλικίας τους.</strong><br><br>Η άδεια παρέχεται ως εναλλακτική της δυνατότητας νόμιμης μείωσης του ωραρίου εκάστου εκ των δύο γονέων κατά 25% , διατηρώντας τις αποδοχές τους, προκειμένου
                        εργαζόμενοι με κυλιόμενα ωράρια να καλύψουν την υποχρέωση φροντίδας των τέκνων τους.<br></p>
                </div>
            </div>
        </div>
    </header>
    ...
    <?php
    // we must check if the user is logged in AND an employee
    if (isset($_SESSION['loggedIn']) && $_SESSION['loggedIn'] == true && $_SESSION['userType'] === 'employee') {
        require 'AithshEidikouSkopou.php';
    } else {
