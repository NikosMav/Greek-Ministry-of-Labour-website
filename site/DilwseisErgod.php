    ...
    <div style="height: 800px;">
        <div class="container-fluid" style="height: 1000px;">
            <div class="row" style="height: 800px;">
                <div class="col-md-6" style="background-image: url(&quot;assets/img/xeirapsia.jpg&quot;);background-repeat: no-repeat;background-size: cover;background-position: center;">
                    <div class="float-right" style="margin-top: 160px;margin-bottom: -2px;height: 13px;background-color: #171f32;width: 700px;margin-right: 15%;"></div>
                    <div class="card shadow-lg float-right" style="height: 300px;margin-top: 1px;background-color: rgba(40,45,50,0.92);width: 700px;margin-right: 15%;">
                        <div class="card-header" style="color: #f0f9ff;">
                            <h1 style="display:none;">h1</h1><h2 class="text-center mb-0">Δήλωση Εργαζόμενου</h2>
                        </div>
                        <div class="card-body">
                            <p class="text-center card-text" style="color: #f0f9ff;font-size: 22px;margin-bottom: 136px;margin-top: 0px;">Δήλωση εργαζομένου και ενημέρωση των δεδομένων σας εισάγωντας τα στοιχεία του και αναθέτοντάς τον σε όποια επιχείρησή σας επιθυμείτε.</p><a class="btn btn-primary btn-block border rounded border-white shadow float-right" role="button"
                                data-bs-hover-animate="pulse" style="font-size: 20px;background-color: #171f32;margin-top: -85px;" href="DilosiErgaz.php"><strong>Δήλωση</strong></a></div>
                    </div>
                </div>
                <div class="col-md-6" style="background-image: url(&quot;assets/img/mpizna.jpg&quot;);background-repeat: no-repeat;background-size: cover;background-position: top;">
                    <div style="margin-top: 160px;margin-bottom: -2px;height: 13px;background-color: #171f32;width: 700px;margin-left: 15%;"></div>
                    <div class="card shadow-lg" style="height: 300px;margin-top: 0px;background-color: rgba(40,45,50,0.92);width: 700px;margin-left: 15%;">
                        <div class="card-header" style="color: #f0f9ff;">
                            <h1 style="display:none;">h1</h1><h2 class="text-center mb-0">Δήλωση Επιχείρησης</h2>
                        </div>
                        <div class="card-body">
                            <p class="text-center card-text" style="color: #f0f9ff;font-size: 22px;margin-bottom: 84px;">Δήλωση των επιχειρήσεών σας και ενημέρωση των δεδομένων σας εισάγωντας τυπικά στοιχεία.</p><a class="btn btn-primary btn-block border rounded border-white shadow float-right" role="button" data-bs-hover-animate="pulse" style="font-size: 20px;background-color: #171f32;"
                                href="DilosiEpix.php"><strong>Δήλωση</strong></a></div>
                    </div>
                </div>
            </div>
        </div>
