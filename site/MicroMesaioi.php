...
<body>
    ...
    <div style="height: 900px;margin-top: 0px;padding: 111px;background-color: rgba(0,0,0,0.15);">
        ...
        <div class="container">
            <div class="row" style="width: 1363px;margin-left: -125px;">
                <div class="col-md-4" style="background-color: rgba(0,0,0,0);">
                    <div style="height: 10px;background-color: #171f32;"></div>
                    <div class="card" style="background-color: rgba(0,0,0,0.2);">
                        <div class="card-header" style="background-color: #f0f9ff;">
                            <h1 style="display:none;">h1</h1><h2 style="display:none;">h2</h2><h3 style="display:none;">h3</h3><h4 style="display:none;">h4</h4><h5 style="display:none;">h5</h5><h6 class="mb-0" style="color: #282d32;margin-bottom: 0px;">Επιχείρηση...</h6>
                            <h1 style="display:none;">h1</h1><h2 style="display:none;">h2</h2><h3 style="display:none;">h3</h3><h4 class="mb-0" style="margin-top: 15px;color: #282d32;">ΛΙΑΝΙΚΉΣ</h4>
                        </div>
                        <div class="card"><img alt="" class="card-img w-100 d-block" src="assets/img/lianikh.jpg" style="height: 230px;">
                        ...
                        <div class="card-body" style="height: 232px;background-color: #f0f9ff;">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><i class="fa fa-chevron-right" data-bs-hover-animate="pulse" style="color: #282d32;"></i><a href="404Error1.php" style="color: #282d32;margin-right: 0px;margin-left: 13px;background-color: rgba(0,0,0,0);">Καταστήματα ένδυσης&nbsp;</a></td>
                                        </tr>
                                        <tr>
                                            <td><i class="fa fa-chevron-right" data-bs-hover-animate="pulse" style="color: #282d32;"></i><a href="404Error2.php" style="color: #282d32;margin-right: 0px;margin-left: 13px;background-color: rgba(0,0,0,0);">Καταστήματα ηλεκτρονικών<br></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div style="height: 6px;background-color: #171f32;"></div>
                </div>
                <div class="col-md-4" style="background-color: rgba(0,0,0,0);">
                    <div style="height: 10px;background-color: #171f32;"></div>
                    <div class="card" style="background-color: rgba(0,0,0,0.2);">
                        <div class="card-header" style="background-color: rgb(240,249,255);">
                            <h1 style="display:none;">h1</h1><h2 style="display:none;">h2</h2><h3 style="display:none;">h3</h3><h4 style="display:none;">h4</h4><h5 style="display:none;">h5</h5><h6 class="mb-0" style="color: #282d32;margin-bottom: 0px;">Επιχείρηση...</h6>
                            <h1 style="display:none;">h1</h1><h2 style="display:none;">h2</h2><h3 style="display:none;">h3</h3><h4 class="mb-0" style="margin-top: 15px;color: #282d32;">ΕΣΤΊΑΣΗΣ</h4>
                        </div>
                        <div class="card"><img alt="" class="card-img w-100 d-block" src="assets/img/estiasi-1.jpg" style="height: 230px;">
                            <div class="card-img-overlay" style="background-color: rgba(0,0,0,0.2);"></div>
                        </div>
                        <div class="card-body" style="height: 232px;background-color: #f0f9ff;">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><i class="fa fa-chevron-right" data-bs-hover-animate="pulse" style="color: #282d32;"></i><a href="404Error3.php" style="color: #282d32;margin-right: 0px;margin-left: 13px;background-color: rgba(0,0,0,0);">Εστιατόρια και ξενοδοχεία&nbsp;</a></td>
                                        </tr>
                                        <tr>
                                            <td><i class="fa fa-chevron-right" data-bs-hover-animate="pulse" style="color: #282d32;"></i><a href="404Error4.php" style="color: #282d32;margin-right: 0px;margin-left: 13px;background-color: rgba(0,0,0,0);">Επιχειρήσεις ψυχαγωγίας<br></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="col-md-4" style="background-color: rgba(0,0,0,0);">
                    ...
                    <div class="card" style="background-color: rgba(0,0,0,0.2);">
                        <div class="card-header" style="background-color: rgb(240,249,255);">
                            <h1 style="display:none;">h1</h1><h2 style="display:none;">h2</h2><h3 style="display:none;">h3</h3><h4 style="display:none;">h4</h4><h5 style="display:none;">h5</h5><h6 class="mb-0" style="color: #282d32;margin-bottom: 0px;">Λοιπές...</h6>
                            <h1 style="display:none;">h1</h1><h2 style="display:none;">h2</h2><h3 style="display:none;">h3</h3><h4 class="mb-0" style="margin-top: 15px;color: #282d32;">ΕΠΙΧΕΙΡΉΣΕΙΣ</h4>
                        </div>
                        <div class="card"><img alt="" class="card-img w-100 d-block" src="assets/img/επιχειρηση.png" style="height: 230px;background-image: url(&quot;assets/img/antrasdouleuei.jpg&quot;);">
                            <div class="card-img-overlay" style="background-color: rgba(0,0,0,0.2);"></div>
                        </div>
                        <div class="card-body" style="height: 232px;background-color: #f0f9ff;">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><i class="fa fa-chevron-right" data-bs-hover-animate="pulse" style="color: #282d32;"></i><a href="COVIDErgod.php" style="color: #282d32;margin-right: 0px;margin-left: 13px;background-color: rgba(0,0,0,0);">Θέλω να μάθω πληροφορίες για τις πιο πρόσφατες οδηγίες εν καιρώ πανδημίας&nbsp;</a></td>
                                        </tr>
                                        <tr>
                                            <td><i class="fa fa-chevron-right" data-bs-hover-animate="pulse" style="color: #282d32;"></i><a href="DilwseisArseis.php" style="color: #282d32;margin-right: 0px;margin-left: 13px;background-color: rgba(0,0,0,0);">Δηλώσεις εναλλακτικών επιλογών εργασίας εν καιρώ πανδημίας<br></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
